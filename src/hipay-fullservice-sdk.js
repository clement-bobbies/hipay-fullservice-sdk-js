...
// returns the year (four digits)
    ...
    // API Calls
    var _performAPICall = function (endpoint, requestParams, checkKey) {
...
console.info('post');
            ...
            return axios.post(endpoint,requestParams,config)
                .then(function(responseJson) {
                    ...
                    if( typeof responseJson['code'] != 'undefined' )  {
                        ...
                        return Promise.reject(new _APIError(responseJson));
    ...
    HiPay.tokenize = function(params) {
        ...
        if(!_isBrowser()) {
            return Promise.reject({"message" : "cant tokenize on server side"});
        ...
        if (errorCollection.length > 0) {
            ...
            return _performAPICall(endpoint, params);
        }
    };
